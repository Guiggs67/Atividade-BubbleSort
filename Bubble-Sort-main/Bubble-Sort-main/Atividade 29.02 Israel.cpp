...
void ImprimeNumero() {
    //O número gerado randomicamente terá como semente o relógio do sistema
...
//Finaliza a cronometragem do bubble sort
auto end = chrono::steady_clock::now();
//Define o valor da contagem
auto diff = end - start;
//Exibe o tempo de execução em milisegundos
std::cout << "Tempo de execução: " << chrono::duration <double, milli>(diff).count() << " ms" << endl;
